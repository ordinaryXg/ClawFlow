...
/** 左侧工作区「工作中心」展开的子视图：会话 / 待办 / 子 Agent / 技能 / 知识库 */
export type WorkspaceHubBranch = 'sessions' | 'todos' | 'subagents' | 'skills' | 'kb';
...
function loadMap(): Record<string, WorkspaceHubBranch> {
  try {
    ...
    for (const [k, v] of Object.entries(o as Record<string, unknown>)) {
      if (v === 'sessions' || v === 'todos' || v === 'subagents' || v === 'skills' || v === 'kb') {
        out[k] = v;
      }
    }
    return out;
