# ClawFlow 开发步骤计划表（任务清单 / AI 可读）

## 元信息

- **仓库根目录占位**：`${REPO_ROOT}`
- **本文件角色**：任务清单（细项 + 依赖 + 验收 + 完成记录）
- **阅读入口**：
  - 总览：`01_PROJECT_OVERVIEW.md`
  - 路线图：`03_ROADMAP.md`
  - 架构：`ClawFlow_产品系统架构说明书.md`
  - 流程：`ClawFlow_开发流程骨架.md`

## TL;DR

- 先做 **P0**：对话闭环 → 技能/连接器管理 → Gateway 状态与启停
- 再做 **P1**：设置（主题/语言/引擎配置）+ 稳定性（错误/加载/一致性策略）
- 质量与发布：测试/CI/打包发布在 P1/P2 逐步补齐

> 目标：基于 `${REPO_ROOT}` 工程，开发类似腾讯 WorkBuddy 的 Electron + TypeScript + OpenClaw 应用软件
>
> **设计原则：**
...
**涉及文件：**
- `${REPO_ROOT}/src/store/index.ts`
- `${REPO_ROOT}/src/store/modules/gatewayStore.ts`
- `${REPO_ROOT}/src/store/modules/chatStore.ts`
- `${REPO_ROOT}/src/store/modules/skillStore.ts`
- `${REPO_ROOT}/src/store/modules/connectorStore.ts`
- `${REPO_ROOT}/src/store/modules/settingsStore.ts`
...
**涉及文件：**
- `${REPO_ROOT}/src/engine/openclaw-engine.ts`（扩展）
- `${REPO_ROOT}/src/preload.ts`（扩展）
- `${REPO_ROOT}/src/global.d.ts`（扩展）
...
**涉及文件：**
- `${REPO_ROOT}/src/pages/ChatPage/index.tsx`
- `${REPO_ROOT}/src/pages/ChatPage/styles.css`
- `${REPO_ROOT}/src/components/chat/MessageList.tsx`
- `${REPO_ROOT}/src/components/chat/MessageItem.tsx`
- `${REPO_ROOT}/src/components/chat/ChatInput.tsx`
- `${REPO_ROOT}/src/components/chat/StreamingMessage.tsx`
...
**涉及文件：**
- `${REPO_ROOT}/src/pages/SkillsPage/index.tsx`
- `${REPO_ROOT}/src/pages/SkillsPage/styles.css`
- `${REPO_ROOT}/src/components/skill/SkillCard.tsx`
- `${REPO_ROOT}/src/components/skill/SkillList.tsx`
- `${REPO_ROOT}/src/components/skill/SkillDetail.tsx`
...
**涉及文件：**
- `${REPO_ROOT}/src/pages/ConnectorsPage/index.tsx`
- `${REPO_ROOT}/src/pages/ConnectorsPage/styles.css`
- `${REPO_ROOT}/src/components/connector/ConnectorCard.tsx`
- `${REPO_ROOT}/src/components/connector/ConnectorForm.tsx`
- `${REPO_ROOT}/src/components/connector/ConnectorList.tsx`
...
**涉及文件：**
- `${REPO_ROOT}/src/pages/SettingsPage/index.tsx`
- `${REPO_ROOT}/src/pages/SettingsPage/styles.css`
- `${REPO_ROOT}/src/locales/zh.json`
- `${REPO_ROOT}/src/locales/en.json`
- `${REPO_ROOT}/src/i18n.ts`（国际化配置）
...
**涉及文件：**
- `${REPO_ROOT}/src/components/Layout.tsx`
...
**涉及文件：**
- `${REPO_ROOT}/src/styles/global.css`
- `${REPO_ROOT}/src/styles/theme.ts`（可选，使用 Ant Design 的 ConfigProvider）
...
**涉及文件：**
- `${REPO_ROOT}/src/components/common/Loading.tsx`
- `${REPO_ROOT}/src/components/common/ErrorBoundary.tsx`
- `${REPO_ROOT}/src/components/common/EmptyState.tsx`
...
**涉及文件：**
- `${REPO_ROOT}/src/__tests__/engine/openclaw-engine.test.ts`
- `${REPO_ROOT}/src/__tests__/store/gatewayStore.test.ts`
- `${REPO_ROOT}/src/__tests__/utils/*.test.ts`
...
**涉及文件：**
- `${REPO_ROOT}/src/__tests__/integration/*.test.tsx`
...
**涉及文件：**
- `${REPO_ROOT}/forge.config.ts`
- `${REPO_ROOT}/webpack.main.config.ts`
- `${REPO_ROOT}/webpack.renderer.config.ts`
...
- `${REPO_ROOT}/ARCHITECTURE.md`（更新）
- `${REPO_ROOT}/CONTRIBUTING.md`（可选）
